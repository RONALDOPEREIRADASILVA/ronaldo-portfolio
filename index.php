...
<body>
    <div class="container">
        <nav>
            <ul>
                <li>
                    <a href="Habilidades.html" target="_blank">Habilidades</a>
                </li>
                <li>
        ...
        <header>
            <div class="center">
                <img src="img/20220727_183152.jpg" alt="">
        ...
        <main>
            ...
            <section>
                ...
                <p>Ola ,tenho como objetivo me aprofundar como desenvolvedor front-end ,e alcançar o ápse da   minha  carreira como sênio! </p><br>
                    ...
                    <div class="tab">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Formado Em Analise E Desenvoliment De Sistema  </td>
                                    <td>Estácio</td>
                                </tr>
                            </tbody>
                        </table>
